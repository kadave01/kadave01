...
<p align="center">
  <img src="https://github.com/kadave01/kadave01/blob/main/ensemble_b.jpg" width="100%" alt="kadave01's avatar">
</p>
...
My research centers on experimental work for next-generation combustor design, with a strong emphasis on introducing H<sub>2</sub> to the energy mix in aviation. I have developed novel, low-cost diagnostic techniques for combustion and spray analysis. In parallel, I pursue the development of low-fidelity analytical and mathematical models to aid in early-stage design space exploration.
...
- **MSc in Aerospace Engineering (Power & Propulsion)** – TU Delft, Netherlands (2018–2020)  
  *CGPA: 8.25/10*
- **B.Tech in Mechanical Engineering** – VJTI, Mumbai, India (2011–2015)  
  *CGPA: 8.1/10*
...
- **TU Delft**, *Netherlands* – PhD Candidate (Oct 2022 – Present)  
  Doctoral research mainly focuses on experimental development of a multi-phase, multi-fuel (kerosene-H<sub>2</sub>) combustor alongwith CRN based analysis of the changes in the combustion chemistry and pollutant formation due to addition of H<sub>2</sub>. Additionally, I also work on development of a novel spray diagnostic technique that could potentially provide quantitative 2D spray characterization at much lowered cost. 

- **TU Delft**, *Netherlands* – Researcher (Dec 2020 – Spet 2022)  
  Worked on CH<sub>4</sub>-H<sub>2</sub> low-emission combustor development as part of the APPU project. Other responsibilities included supervision of MSc theses and designing the experimental facility for the project.

- **Feedback Infra Pvt. Ltd.**, *India* – Design Engineer (Jul 2015 – Jul 2018)  
  Worked on power plant optimization, technical feasibility studies, and proposal development for utility-scale energy infrastructure projects in India, Indonesia and Africa.

---

## 🛠 Skills & Tools

- **Experimentation:** Designing and running lab-scale experiments in reactive flows
- **Diagnostics - Combustion:** PIV, chemiluminescence, exhaust-gas analysis, PLIF 
- **Diagnostics - Spray:** Optical techniques including MSI, IPI and shadowgraphy
- **CRN Modelling:** Cantera (Python), Chemkin-Pro
...
- Bridging experimental work with predictive modeling  
- Advocating for reproducible, open-source science  
...
- Sarah Link, **Kaushal Dave**, Francesca De Domenico, Arvind Gangoli Rao, Georg Eitelberg. *Experimental Analysis of Dual-Fuel (CH<sub>4</sub>/H<sub>2</sub>) Capability in a Partially-Premixed Swirl-Stabilized Combustor*. *International Journal of Hydrogen Energy*, 2025.
- **Kaushal Dave**, Sarah Link, Francesca De Domenico, Ferry Schrijer, Fulvio Scarano, Arvind Gangoli Rao. *Kerosene-H<sub>2</sub> Blending Effects on Flame Properties in a Multi-Fuel Combustor*. *Fuel Communications*, 2025.
